...
export function isSwappableMenuCategory(
  cat: string,
): cat is SwappableMenuCategory {
  return (SWAPPABLE_MENU_CATEGORIES as readonly string[]).includes(cat);
}

export function getSwappablePoolLimit(
  limits: Partial<Record<MenuCategory, number>>,
): number {
  return SWAPPABLE_MENU_CATEGORIES.reduce(
    (sum, cat) => sum + (limits[cat] ?? 0),
    0,
  );
}
...
function countLiveCounterSlots(menuItemIds: string[]): number {
  ...
  menuItemIds.forEach((id) => {
    ...
    if (m?.category === LIVE_COUNTER_CATEGORY && m.subcategory)
      subs.add(m.subcategory);
  });
  return subs.size;
}
...
function buildSwappablePoolUnits(items: MenuItem[]): PoolUnit[] {
  ...
  Object.entries(lcBySub).forEach(([sub, subItems]) => {
    units.push({
      ids: subItems.map((item) => item.id),
      price: counterSortPrice(sub),
    });
  });
...
export function getIncludedMenuItemIds(
  ...
  Object.entries(otherCats).forEach(([cat, list]) => {
    ...
    const sorted = [...list].sort(
      (a, b) => getItemExtraPrice(a) - getItemExtraPrice(b),
    );
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  {
    id: "wd-f8",
    name: "Special Boomerang (Pineapple, Orange & Peru)",
    category: "Welcome Drink",
    subcategory: "Fresh Fruit Juice",
    price: 0,
  },
  {
    id: "wd-f9",
    name: "Special Tulsidhar (Pineapple, Chikku & Tulsi)",
    category: "Welcome Drink",
    subcategory: "Fresh Fruit Juice",
    price: 0,
  },
  {
    id: "wd-f10",
    name: "Special Golden Punch (Pineapple & Orange)",
    category: "Welcome Drink",
    subcategory: "Fresh Fruit Juice",
    price: 0,
  },
  {
    id: "wd-f11",
    name: "Special Raja Rani (Pineapple & Rose Syrup)",
    category: "Welcome Drink",
    subcategory: "Fresh Fruit Juice",
    price: 0,
  },
  // Welcome Drink — Mocktails (+₹20 Extra)
  {
    ...
    category: "Welcome Drink",
    subcategory: "Mocktails (+₹20 Extra)",
    price: 20,
  },
  {
    id: "wd-m2",
    name: "Special Virgin Pina Colada",
    category: "Welcome Drink",
    subcategory: "Mocktails (+₹20 Extra)",
    price: 20,
  },
  ...
  {
    id: "wd-m7",
    name: "Special Strawberry Colada",
    category: "Welcome Drink",
    subcategory: "Mocktails (+₹20 Extra)",
    price: 20,
  },
  ...
  {
    id: "ps1",
    name: "Paneer Salt-N-Pepper",
    category: "Starters",
    subcategory: "Paneer Starter",
    price: 0,
  },
  {
    id: "ps3",
  ...
  {
    id: "ps6",
    name: "Special Paneer Pahadi Tikka",
    category: "Starters",
    subcategory: "Paneer Starter",
    price: 0,
  },
  ...
  {
    id: "ps8",
    name: "Special Maladi Paneer Tikka Dry",
    category: "Starters",
    subcategory: "Paneer Starter",
    price: 0,
  },
  ...
  {
    id: "dl4",
    name: "Gujarati Kadhi (Sweet/Spicy)",
    category: "Dal",
    price: 0,
  },
  ...
  {
    id: "sw2",
    name: "Special Badam Moongdal Halwa",
    category: "Sweets & Ice Cream",
    subcategory: "Sweets",
    price: 0,
  },
  ...
  {
    id: "sw7",
    name: "Special Jalebi with Rabdi",
    category: "Sweets & Ice Cream",
    subcategory: "Sweets",
    price: 0,
  },
  ...
  // Ice Cream — Special (+₹25)
  {
    ...
    name: "Black Current",
    category: "Sweets & Ice Cream",
    subcategory: "Ice Cream — Special (+₹25 Extra)",
    price: 25,
  },
  {
    id: "ic-s2",
  ...
  {
    id: "lc-si1",
    name: "Assorted Dosa / Uttapam",
    category: "Live Counters",
    subcategory: "South Indian Counter",
    price: 0,
  },
  {
    id: "lc-si2",
  ...
  // Live Counters — Chinese / Oriental
  {
    ...
    name: "Veg Fried Rice",
    category: "Live Counters",
    subcategory: "Chinese / Oriental Counter",
    price: 0,
  },
  {
    id: "lc-ch2",
  ...
  {
    id: "lc-ch10",
    name: "Veg in Black Pepper Sauce",
    category: "Live Counters",
    subcategory: "Chinese / Oriental Counter",
    price: 0,
  },
  ...
  // Live Counters — Additional
  {
    ...
    category: "Live Counters",
    subcategory: "Additional Counters",
    price: 0,
  },
  {
    id: "lc-a2",
...
export function isMenuItemAllowedForPackage(
  itemId: string,
...
export function filterMenuIdsForPackage(
  menuItemIds: string[],
  platePackageId: string,
): string[] {
  return menuItemIds.filter((id) =>
    isMenuItemAllowedForPackage(id, platePackageId),
  );
}

export function getMenuItemsForPackage(
  platePackageId: string,
  category: string,
): MenuItem[] {
  const plate = PLATE_PACKAGES.find((p) => p.id === platePackageId);
...
export function getPackageCategoryLabel(
  ...
  return (
    plate.categoryLabels?.[category as MenuCategory] ?? translate(category)
  );
}
...
export const DECOR_OPTIONS: DecorOption[] = [
  {
    ...
    price: 8000,
    description: "Fresh flower entry gate",
    events: [
      WEDDING,
      ENGAGEMENT,
      SANGEET,
  ...
  },
  {
    ...
    price: 6000,
    description: "Warm fairy lights overhead",
    events: [
      WEDDING,
      ENGAGEMENT,
      SANGEET,
  ...
  },
  {
    ...
    price: 4500,
    priceMax: 15000,
    description: "Themed balloon arrangements",
    events: [
      BIRTHDAY,
      ANNIVERSARY,
      RETIREMENT,
  ...
  },
  {
    ...
    name: "Theme Backdrop",
    price: 7000,
    description: "Custom photo backdrop",
    events: [
      BIRTHDAY,
      ANNIVERSARY,
      RETIREMENT,
  ...
  {
    id: "d6",
    name: "Mandap Floral Setup",
    price: 25000,
    description: "Traditional flower mandap",
    events: [WEDDING],
  },
  {
    id: "d7",
    name: "Haldi Yellow Theme",
    price: 9000,
    description: "Marigold & yellow drapes",
    events: [HALDI],
  },
  {
    id: "d8",
    name: "Mehendi Green Theme",
    price: 9000,
    description: "Green florals & jhumkas",
    events: [MEHENDI],
  },
  {
    id: "d9",
    name: "Ring Ceremony Platter",
    price: 3000,
    description: "Decorated ring tray",
    events: [ENGAGEMENT],
  },
  {
    id: "d10",
    ...
    price: 6500,
    description: "Floral cradle for baby",
    events: [NAMING, BABY_SHOWER],
  },
  {
    id: "d11",
    name: "Baby Shower Drapes",
    price: 5500,
    description: "Pastel drapes & props",
    events: [BABY_SHOWER],
  },
  {
    id: "d12",
    name: "Corporate Branding Standee",
    price: 4000,
    description: "Logo standees & flags",
    events: [
      CORPORATE,
      GALA,
      AWARDS,
  ...
  {
    id: "d13",
    name: "Stage Podium & Banner",
    price: 5000,
    description: "Podium with branded banner",
    events: [
      CORPORATE,
      GALA,
      AWARDS,
  ...
  },
  {
    ...
    price: 3500,
    description: "Table linens & notepads",
    events: [CORPORATE, AGM, SOCIETY, REDEV, SEMINAR],
  },
  {
    id: "d15",
    name: "Awards Spotlight Setup",
    price: 12000,
    description: "Spotlight + red carpet",
    events: [GALA, AWARDS, CHARITY, FUNDRAISER],
  },
  {
    id: "d16",
    name: "Garba Dandiya Décor",
    price: 8500,
    description: "Traditional chaniya theme",
    events: [GARBA],
  },
  {
    id: "d17",
    ...
    price: 18000,
    description: "Illuminated dance floor",
    events: [
      GARBA,
      DANCE_PRACTICE,
      SANGEET,
  ...
  {
    id: "d18",
    name: "Karaoke Lounge Setup",
    price: 6000,
    description: "Mood lighting + props",
    events: [KARAOKE, KITTY],
  },
  {
    id: "d19",
    name: "Cake Table Décor",
    price: 2500,
    description: "Decorated cake table",
    events: [
      BIRTHDAY,
      ANNIVERSARY,
      RETIREMENT,
  ...
  {
    id: "d20",
    name: "School Theme Cutouts",
    price: 5500,
    description: "Cartoon/educational props",
    events: [PRESCHOOL, SCHOOL],
  },
  {
    id: "d21",
    name: "Charity Donor Wall",
    price: 7000,
    description: "Sponsor & donor display",
...
export const STAGE_OPTIONS: DecorOption[] = [
  {
    id: "s0",
    name: "Basic Stage Decoration",
    price: 0,
    description: "Basic stage setup",
  },
  {
    id: "s1",
    name: "Classic Floral Stage",
    price: 15000,
    description: "Roses + drapes",
  },
  {
    id: "s2",
    name: "Royal Mandap",
    price: 35000,
    description: "Traditional wedding mandap",
  },
  {
    id: "s3",
    name: "LED Wall Stage",
    price: 45000,
    description: "Full LED backdrop with visuals",
  },
  {
    id: "s4",
    name: "Minimal Modern",
    price: 18000,
    description: "Clean geometric stage design",
  },
  {
    id: "s5",
    name: "Birthday Theme Stage",
    price: 12000,
    description: "Character / theme based",
  },
];
...
export const EXTRA_SERVICES: ExtraService[] = [
  ...
  {
    id: "e7",
    name: "Smoke & Cold Pyro Entry With Smoke Bubble Machine",
    price: 800,
    priceMax: 1000,
    unit: "show",
    subtitle: "per Pyro or Smoke Bubble Machine",
  },
...
export function formatMenuPackageExtraPrice(
  item: MenuPackageCardExtra,
): string {
...
export const MENU_PACKAGE_CARD_EXTRAS: MenuPackageCardExtra[] = [
  ...
  { id: "e6", name: "Anchor / MC", price: 3500 },
  {
    ...
    price: 800,
    priceMax: 1000,
    detail: "per Pyro or Smoke Bubble Machine",
    wide: true,
  },
...
export const VENUE_OPTIONS: VenueOption[] = [
  {
    ...
    pricePerHour: 7500,
    description: "Indoor AC hall · up to 400 guests",
  },
];
