...
const CalendarPage = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      {/* One grid so Upcoming lines up under Lead vs Conversion */}
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4 xl:items-stretch">
        ...
        <aside className="flex h-full min-h-[22rem] flex-col rounded-xl border border-border/70 bg-card shadow-soft sm:col-span-2 xl:col-span-1 xl:min-h-0">
