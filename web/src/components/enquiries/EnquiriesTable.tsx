...
import { ENQUIRY_STATUS_CLASS, isOpenEnquiryStatus } from "@/lib/enquiryPipeline";
            ...
            <TableRow key={enquiry.id} className="border-border/50">
                ...
                <Badge
                  ...
                  className={cn(
                    ...
                    enquiry.status === "booked" || enquiry.bookingId
                      ? ENQUIRY_STATUS_CLASS.booked
                      : ENQUIRY_STATUS_CLASS[enquiry.status],
                  )}
                >
                  {enquiry.status === "booked" || enquiry.bookingId
              ...
              <TableCell className="text-right">
                <div className="flex items-center justify-end gap-2">
                  {!isOpenEnquiryStatus(enquiry.status) || enquiry.bookingId ? (
                    <Button
                      type="button"
                      variant="outline"
                      size="sm"
