        ...
        {days.map((day) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group min-h-[4.25rem] border-b border-r border-border/50 p-1 text-left transition-colors sm:min-h-[5rem] sm:p-1.5",
                ...
                {dayEvents.slice(0, 2).map((event) => (
                  <div
                    ...
                    className={cn(
                      ...
                      event.status === "lost" && "bg-rose-500/10 text-rose-700/80 line-through dark:text-rose-300/80",
                    )}
                  >
