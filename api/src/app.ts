...
import { ensureWorkspaceSettings } from './modules/workspace/workspace.service.js';
...
export async function buildApp() {
  ...
  try {
    await ensureWorkspaceSettings(app.prisma);
    app.log.info('Workspace settings ready');
  } catch (error) {
    app.log.warn({ err: error }, 'Workspace settings seed skipped');
  }
